...
<img src="'. base_url() .'uploads/xxxXXX/result_'. $user_id .'.jpg" class="replace-loader" alt="">
</a>
<div id="try_again">
    <a class="btn btn-default try-again-btn" href="'. base_url().'xxxXXX?step=1">
        <span class="glyphicon glyphicon-repeat" aria-hidden="true"></span>
    Not happy with results? Try again
</a>
</div>
<div class="result-image-description">xxxXXX</div>
...
';
                            ...
                            echo '
<div class="quiz-cover">
<a href="'. base_url().'xxxXXX?step=1" class="start-load main-image">
<img src="'. asset_url().'img/sample/edu.jpg" class="replace-loader" alt=""/>
</a>
<div style="padding: 10px 0 5px">
</div>
<a class="btn btn-primary btn-lg start-load" href="'. base_url().'xxxXXX?step=1">Start</a>
';
                        }
                        ?>
