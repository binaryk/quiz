...
$links[] = '<div class="col-md-4"><a href="'.base_url().'eesse" class="sidebar-quiz"><img src="'.asset_url().'img/sample/eesse_sample.jpg" alt=""/><h5><strong>AAA</strong></h5><span class="clearfix"></span></a></div>';$links[] = '<div class="col-md-4"><a href="'.base_url().'eesse" class="sidebar-quiz"><img src="'.asset_url().'img/sample/eesse_sample.jpg" alt=""/><h5><strong>AAA</strong></h5><span class="clearfix"></span></a></div>';$links[] = '<div class="col-md-4"><a href="'.base_url().'eesse" class="sidebar-quiz"><img src="'.asset_url().'img/sample/eesse_sample.jpg" alt=""/><h5><strong>AAA</strong></h5><span class="clearfix"></span></a></div>';
