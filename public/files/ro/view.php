                    ...
                    <div class="jumbotron-container">
                        ...
                        <div class="quiz-analyse" style="display: none">
                            ...
                            <p id="status-text">
                                <?php
                                if (!isset($_GET['step'])) {
                                    echo "Analizam profilul de Facebook ...";
                                }elseif (isset($_GET['step']) && $_GET['step'] == 2) {
                                    echo "Calculam rezultatele ...";
                                }
                                ?>
                            </p>
                            <div class="like-box">
...
<a class="fb-box-share fb-box-share-single" href="#" onclick="return share_and_redirect(\''.$url.'?share=1\', \''.$url.'?share=1\')">
    ...
    <span class="fb-box-share-text">Distribuie pe Facebook</span>
</a>
<div style="padding: 10px 0 5px">
</div>
<a href="#" onclick="return share_and_redirect(\''.$url.'?share=1\', \''.$url.'?share=1\')">
<img src="'. base_url() .'uploads/[[QUIZ_NAME]]/result_'. $user_id .'.jpg" class="replace-loader" alt="">
</a>
<div id="try_again">
    <a class="btn btn-default try-again-btn" href="'. base_url().'[[QUIZ_NAME]]?step=1">
        <span class="glyphicon glyphicon-repeat" aria-hidden="true"></span>
    Nu esti multumit de rezultat? Incearca din nou
</a>
</div>
<div class="result-image-description">E?ti o pisic? atât de adorabil?! To?i trebuie s? vad? asta!!! Împ?rt??e?te acest rezultat cu prietenii, las?-i s? ?tie asta!</div>
...
<a class="btn btn-primary btn-lg start-load" href="'. base_url().'[[QUIZ_NAME]]?step=1">Start</a>
';
                        }
                        ?>
